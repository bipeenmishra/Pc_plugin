...
(function () {
    ...
    Auth0AccountData.subdomain = 'auth.marketredesign.com';
    Auth0AccountData.clientID = 'QbDKFV5z3Dqs8x5mubBd5bSwVVj1zuE1';

    // The Auth0 subdomain and client ID need to be shared with the popup dialog
    mrd-auth0-spa-vue .setItem('Auth0Subdomain', Auth0AccountData.subdomain);
    mrd-auth0-spa-vue .setItem('Auth0ClientID', Auth0AccountData.clientID);
    ...
    function showLoginPopup() {
        ...
        var fullUrl = 'https://api.pricecypher.com' + '/popup.html';
